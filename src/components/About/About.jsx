...
const AnimatedSection = ({ children, delay = 0, classes }) => {
  ...
  return (
    <div
      ref={ref}
      className={`transition-all duration-1000 ease-out transform ${classes} ${
...
const About = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen w-full py-6 md:py-24">
      ...
      <AnimatedSection delay={200} classes="w-full md:w-[80%] flex flex-col justify-center items-start px-6 md:mx-0">

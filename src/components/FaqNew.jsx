        ...
        >
          ...
          >
            <div className="flex items-center gap-4">
              <span className="flex items-center justify-center bg-gray-100 rounded-full w-8 h-8 text-sm font-medium text-gray-700 group-hover:bg-gray-200 transition-colors duration-300">
                {index + 1}
              </span>
              <h3 className="text-left text-sm md:text-base font-medium text-gray-900">
                {item.title}
              </h3>
            </div>
            <span className="ml-4 flex-shrink-0">
              <Plus 
                className={`w-5 h-5 text-gray-500 transition-transform duration-300 ease-in-out transform ${
          ...
          >
            <p className={`p-4 md:p-6 text-sm md:text-base text-gray-600 border-t transform transition-all duration-300 ${
              openIndex === index 

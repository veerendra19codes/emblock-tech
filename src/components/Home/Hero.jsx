...
const Hero = () => {
  return (
    ...
    <div className="flex flex-col gap-8 justify-center items-center w-full h-full bg-[url('/herobg.jpg')]">
        ...
        <div className="hero w-full h-full flex justify-between items-center px-12 pt-44">


          <div className="w-5/8 right flex justify-center items-start flex-col gap-4 font-normal">

            <h1 className="text-[60px] leading-none align-middle flex justify-center items-center mt-4 ">
              <span className="opacity-0 translate-y-full animate-slide-up-text-1  animate-fill-mode-forwards">
                The Future is 
              </span>
              <span className="opacity-0 translate-y-full p-6 border border-transparent shadow-lg rounded-full text-[30px] font-semibold mx-6 animate-slide-down-text-1 animate-fill-mode-forwards">Connected</span>
            </h1>
            
            <h1 className="text-[60px] leading-none align-middle flex justify-center items-center">
              <span className=" opacity-0 translate-y-full animate-slide-up-text-2 animate-fill-mode-forwards">At</span>   

              <span className="opacity-0 translate-y-full p-6 border border-transparent shadow-lg rounded-full text-[35px] font-bold text-white bg-customgray mx-6 animate-slide-up-text-3 animate-fill-mode-forwards uppercase">Embock Tech</span> 

              <span className="opacity-0  translate-y-full animate-slide-up-text-4 animate-fill-mode-forwards">we turn</span>     <span className="opacity-0 translate-x-full p-6 border border-gray-600 shadow-lg rounded-full text-[30px] mx-6 font-semibold animate-slide-left-text-5 animate-fill-mode-forwards">Ideas</span>
            </h1>

            <h1 className="text-[60px] leading-none align-middle flex justify-center items-center">
              <span className=" opacity-0 translate-y-full animate-slide-up-text-2 animate-fill-mode-forwards">into possibilities with</span>   

              <span className="opacity-0 translate-y-full p-6 border border-transparent shadow-lg rounded-full text-[35px] font-bold text-white bg-customgray mx-6 animate-slide-up-text-3 animate-fill-mode-forwards uppercase">Iot & Software</span> 
            </h1>

            <h1 className="text-[60px] leading-none align-middle flex justify-center items-center">
              <span className=" opacity-0 translate-y-full animate-slide-up-text-2 animate-fill-mode-forwards">solutions, empowering you, every</span>   
            </h1>
          ...
          <div className="w-3/8 h-full flex justify-center items-center">

  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen w-full">
      <section className="bg-[url('/herobg.jpg')] w-full flex flex-col p-6 md:p-32 justify-start items-start md:pt-48">
        ...
        <h1 className="w-full md:w-[80%] text-[25px] md:text-[60px] font-normal flex-wrap leading-none my-4">
        ...
        <p className="text-gray-500 font-medium text-sm md:text-2xl w-full md:w-[60%] mt-4 md:mt-8">
      ...
      <section className="w-full important-advisory bg-customblack px-6 py-24 md:p-32 flex flex-col justify-start items-start">
        <div className="flex gap-2 justify-center items-center">
          ...
          <div className="flex justify-center items-start flex-col gap-2 leading-none ">
            <h1 className="w-full md:w-[80%] text-[25px] lg:text-[60px] text-white leading-none">
          ...
          <div className="text-gray-400 text-xs md:text-lg font-medium flex flex-col justify-start items-start mt-24">
      ...
      <section className="jobs w-full bg-white p-6 py-12 md:p-32 felx flex-col justify-start items-start">
        {jobs.map((job) => (

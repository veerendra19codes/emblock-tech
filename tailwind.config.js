  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "slide-up-text-1": "slide-up-text-1 0.5s ease-out forwards",
        "slide-up-text-2": "slide-up-text-1 0.5s ease-out 0.1s forwards",
        "slide-up-text-3": "slide-up-text-1 0.5s ease-out 0.2s forwards",
        "slide-up-text-4": "slide-up-text-1 0.5s ease-out 0.3s forwards",
        ...
        "marquee-right-new": "marquee-right-new 5s linear infinite",
      ...
      keyframes: {
        ...
        marqueeright: {
          ...
          "100%": { transform: "translateX(calc(0% + 16px))" },
        },
